...
`Download`_ the bundle and put it under the ``Ws\\Bundle\\`` namespace.
Then, like for any other bundle, include it in your Kernel class::
    ...
    public function registerBundles()
    {
        $bundles = array(
            ...
            new Ws\Bundle\GeneratorBundle\WsGeneratorBundle(),
        );
...
The ``WsGeneratorBundle`` comes with four new commands that can be run in
...
.. _Download: http://github.com/web-solution/WsGeneratorBundle
...
file structure in ``APP_PATH/Resources/WsGeneratorBundle/skeleton`` or
``BUNDLE_PATH/Resources/WsGeneratorBundle/skeleton`` if you want to extend
...
``APP_PATH/Resources/WsGeneratorBundle/skeleton``.
...
.. code-block: jinja
  ...
  {# in app/Resources/WsGeneratorBundle/skeleton/crud/actions/create.php.twig #}
