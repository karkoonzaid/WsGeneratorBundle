...
The ``ws:generate:bundle`` generates a new bundle structure and automatically
...
.. code-block:: bash
    ...
    php app/console ws:generate:bundle
...
.. code-block:: bash
    ...
    php app/console ws:generate:bundle --namespace=Acme/Bundle/BlogBundle --no-interaction
...
* ``--namespace``: The namespace of the bundle to create. The namespace should
  ...
  .. code-block:: bash
        ...
        php app/console ws:generate:bundle --namespace=Acme/Bundle/BlogBundle
...
* ``--bundle-name``: The optional bundle name. It must be a string ending with
  the ``Bundle`` suffix:
    ...
    .. code-block:: bash
        ...
        php app/console ws:generate:bundle --bundle-name=AcmeBlogBundle
...
* ``--dir``: The directory in which to store the bundle. By convention, the
  command detects and uses the applications's ``src/`` folder:
    ...
    .. code-block:: bash
        ...
        php app/console ws:generate:bundle --dir=/var/www/myproject/src
...
* ``--format``: (**annotation**) [values: yml, xml, php or annotation]
  ...
  already installed:
    ...
    .. code-block:: bash
        ...
        php app/console ws:generate:bundle --format=annotation
...
* ``--structure``: (**no**) [values: yes|no] Whether or not to generate a
  ...
  documentation, web assets and translations dictionaries:
    ...
    .. code-block:: bash
        ...
        php app/console ws:generate:bundle --structure=yes
