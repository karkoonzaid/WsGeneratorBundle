...
class Validators
{
    public static function validateBundleNamespace($namespace)
    {
        ...
        if (false === strpos($namespace, '\\')) {
            ...
            $msg[] = 'If you\'ve specified a vendor namespace, did you forget to surround it with quotes (init:bundle "Ws\BlogBundle")?';
    ...
    public static function validateControllerName($controller)
    {
        try {
            ...
            throw new \InvalidArgumentException(
                sprintf(
                    'The controller name must contain a : ("%s" given, expecting something like WsBlogBundle:Post)',
                    $controller
                )
            );
        }
    ...
    public static function validateEntityName($entity)
    {
        if (false === strpos($entity, ':')) {
            throw new \InvalidArgumentException(sprintf('The entity name must contain a : ("%s" given, expecting something like WsBlogBundle:Blog/Post)', $entity));
        }
