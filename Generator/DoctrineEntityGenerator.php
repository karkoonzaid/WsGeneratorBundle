...
class DoctrineEntityGenerator extends Generator
{
    ...
    public function generate(BundleInterface $bundle, $entity, $format, array $fields, $withRepository)
    {
        ...
        $entityRepositoryClass = $this->registry->getAliasNamespace($bundle->getName()).'\\Repository\\'.$entity.'Repository';
        ...
        if ($withRepository) {
            $class->customRepositoryClassName = $entityRepositoryClass;
        }
        $class->mapField(array('fieldName' => 'id', 'type' => 'integer', 'id' => true));
        $class->mapField(array('fieldName' => 'token', 'type' => 'string', 'nullable' => false, 'unique' => true));
        $class->mapField(array('fieldName' => 'createdAt', 'type' => 'datetime', 'nullable' => false));
        $class->mapField(array('fieldName' => 'updatedAt', 'type' => 'datetime', 'nullable' => true));
        $class->setTableName('ws_'. strtolower($entity));
